<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageHOME2.master" AutoEventWireup="true" CodeFile="CONTATO1.aspx.cs" Inherits="noticias" %>
    ...
    <asp:ListItem>--</asp:ListItem>
        ...
        <asp:ListItem>TO</asp:ListItem>
                ...
                <p class="style3">                   
                    ...
                    <asp:TextBox ID="txtCod" runat="server" Width="40px"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" 
                        ControlToValidate="txtCod" ErrorMessage="Preencha o campo em branco">*</asp:RequiredFieldValidator>
                </p>
                <p class="style3">                   
                   Mensagem:
