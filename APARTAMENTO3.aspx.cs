...
public partial class noticias : System.Web.UI.Page
{
    ...
    {
        if (Session["APARTAMENTO3"] != "OK")
        {
            Response.Redirect("APARTAMENTO3.aspx");
        }
        DataView dv;
        ...
        else
        {
            ...
            hl1.NavigateUrl = "APARTAMENTO.aspx";
            hl1.Text = "<< 1";
            hl2.NavigateUrl = "APARTAMENTO2.aspx";
            hl2.Text = "2";

            if (dv.Table.Rows.Count > 1)
            {
                hl3.NavigateUrl = "APARTAMENTO3.aspx";
                hl3.Text = "3 >>";
                Session["APARTAMENTO3"] = "OK";
            }
