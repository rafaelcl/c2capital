<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageHOME.master" AutoEventWireup="true" CodeFile="IMOVEIS2.aspx.cs" Inherits="noticias" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div id="titlenot">
            <asp:ImageButton ID="ImageButton1" runat="server" 
                ImageUrl="~/img/tituloimoveis.fw.png" onclick="ImageButton1_Click" Width="900px"  />
        </div>
        <div id="conteudo3">
