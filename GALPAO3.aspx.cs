...
public partial class noticias : System.Web.UI.Page
{
    ...
    {
        if (Session["GALPAO3"] != "OK")
        {
            Response.Redirect("GALPAO3.aspx");
        }
        DataView dv;
        ...
        else
        {
            ...
            hl1.NavigateUrl = "GALPAO.aspx";
            hl1.Text = "<< 1";
            hl2.NavigateUrl = "GALPAO2.aspx";
            hl2.Text = "2";

            if (dv.Table.Rows.Count > 1)
            {
                hl3.NavigateUrl = "GALPAO3.aspx";
                hl3.Text = "3 >>";
                Session["GALPAO3"] = "OK";
            }
