...
public partial class noticias : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            lblend2.Text = dv.Table.Rows[0]["tipo_imo"].ToString() + " / " + dv.Table.Rows[1]["cidade_imo"].ToString() + " - " + dv.Table.Rows[1]["estado_imo"].ToString();
            ...
            lblend3.Text = dv.Table.Rows[0]["tipo_imo"].ToString() + " / " + dv.Table.Rows[2]["cidade_imo"].ToString() + " - " + dv.Table.Rows[2]["estado_imo"].ToString();
            ...
            lblend4.Text = dv.Table.Rows[0]["tipo_imo"].ToString() + " / " + dv.Table.Rows[3]["cidade_imo"].ToString() + " - " + dv.Table.Rows[3]["estado_imo"].ToString();
